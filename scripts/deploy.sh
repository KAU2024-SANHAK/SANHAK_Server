...
BUILD_PATH=$(ls /home/ubuntu/sanhak-server/kkoolbeeServer-0.0.1-SNAPSHOT.jar)
JAR_NAME=$(basename $BUILD_PATH)
echo "[$NOW_TIME] build 파일명: $JAR_NAME"

echo "[$NOW_TIME] build 파일 복사"
DEPLOY_PATH=/home/ubuntu/sanhak-server/nonstop/jar/
...
IDLE_APPLICATION=$IDLE_PROFILE-Sanhak-Server.jar
...
nohup java -jar -Duser.timezone=Asia/Seoul -Dspring.profiles.active=$IDLE_PROFILE $IDLE_APPLICATION_PATH >> /home/ubuntu/sanhak-server/deploy.log 2>/home/ubuntu/sanhak-server/deploy_err.log &
